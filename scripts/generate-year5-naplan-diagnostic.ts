...
/**
 * YEAR 5 NAPLAN DIAGNOSTIC GENERATION SCRIPT
 * =========================================
 * 
 * Generates diagnostic questions for Year 5 NAPLAN using the enhanced validation system
 * 
 * Features:
 ...
 * 
 * Run: npx tsx scripts/generate-year5-naplan-diagnostic.ts
 */
...
async function main() {
  console.log('🎯 GENERATING YEAR 5 NAPLAN DIAGNOSTIC - ENHANCED SYSTEM');
  console.log('======================================================================');
  console.log('Using enhanced generation system with self-flagging validation...');
  console.log('');
  console.log('🚀 Features:');
  console.log('📖 Reading section: 8 passages (150 words each) with multiple questions');
  ...
  try {
    ...
    console.log('📊 YEAR 5 NAPLAN TEST STRUCTURE:');
    console.log('=====================================');
    ...
    console.log('📖 Reading passages will be generated with proper word counts');
    ...
    console.log('');
    console.log('🎉 YEAR 5 NAPLAN DIAGNOSTIC GENERATION COMPLETE!');
    console.log('==============================================');
    ...
    console.log('- Generate Year 7 NAPLAN diagnostic');
    console.log('');
    console.log('✨ Year 5 NAPLAN diagnostic generation successful!');

  } catch (error) {
    console.error('❌ Year 5 NAPLAN diagnostic generation failed:', error);
