...
async function fetchLogicalDeductionQuestions() {
  console.log('Fetching first 30 Logical Deduction & Conditional Reasoning questions...\n');
  ...
  let output = 'VIC SELECTIVE ENTRY - LOGICAL DEDUCTION & CONDITIONAL REASONING\n';
  ...
  // Save to /tmp/
  const filename = '/tmp/logical_deduction_q1_30.txt';
...
fetchLogicalDeductionQuestions();
