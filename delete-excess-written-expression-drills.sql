-- DELETE EXCESS WRITTEN EXPRESSION DRILL QUESTIONS FOR EDUTEST
-- 
...
-- STEP 1: First delete related question_attempt_history records
...
-- STEP 2: Now delete the excess questions - keep the most recently created question per sub_skill/difficulty
WITH questions_to_delete AS (
    SELECT 
        id,
        sub_skill,
